...
config = config()
config.General.requestName = 'crab_L5JERC_MuEG_2018A_20UL18_JERCL5_Run6'
config.General.workArea = 'crab_L5JERC_MuEG_2018A_20UL18_JERCL5_TestRun'
...
config.Data.inputDataset = '/MuonEG/Run2018A-12Nov2019_UL2018_rsb-v1/MINIAOD'
