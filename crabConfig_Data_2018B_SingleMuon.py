...
config = config()
config.General.requestName = 'crab_L5JERC_Single_Muon_2018B_20UL18_JERCL5_Run1'
config.General.workArea = 'crab_L5JERC_Single_Muon_2018B_20UL18_JERCL5_TestRun'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'JEC_Data_2018B_MINIAOD_cfg.py' 
config.JobType.inputFiles = ['Summer19UL18_RunB_V5_DATA','Summer19UL18_JRV2_MC_SF_AK8PFPuppi.txt','Summer19UL18_JRV2_MC_SF_AK4PFchs.txt','Summer19UL18_JRV2_MC_PtResolution_AK4PFchs.txt','Summer19UL18_JRV2_MC_PtResolution_AK8PFPuppi.txt']
...
config.Data.inputDataset = '/SingleMuon/Run2018B-12Nov2019_UL2018-v2/MINIAOD'
