...
config = config()
config.General.requestName = 'crab_L5JERC_Single_Muon_2018A_20UL18_JERCL5_Run1'
config.General.workArea = 'crab_L5JERC_Single_Muon_2018A_20UL18_JERCL5_TestRun'
...
config.Data.inputDataset = '/SingleMuon/Run2018A-12Nov2019_UL2018-v3/MINIAOD'
